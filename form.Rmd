...
<form name='submit-to-google-sheet'>
  <div class="form-group">
   ...
   <select class="form-control" id="exampleFormControlSelect2" name="select2" multiple>
     <option name="select2-1">1</option>
     <option name="select2-2">2</option>
     <option name="select2-3">3</option>
     <option name="select2-4">4</option>
     <option name="select2-5">5</option>
   </select>
